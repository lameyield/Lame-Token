...
contract LameToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xC1560eb19633C646bD28Bff04D6AdeD41Dd9F2Cf); // Marketing Address
    ...
    string private _name = "LameYield.finance";
    string private _symbol = "LMY";
